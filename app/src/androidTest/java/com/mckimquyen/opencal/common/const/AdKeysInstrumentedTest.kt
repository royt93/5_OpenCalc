...
class AdKeysInstrumentedTest {
    ...
    @Test fun vipSecret_decodesToExpectedPlainKey() {
        // VIP_SECRET = plain key 30 ngày (đã Base64-encode trong BuildConfig.VIP_SECRET_B64)
        assertEquals("9fA0q7eN!27cLx04@21993Y2u0I7#Q0", AdKeys.VIP_SECRET)
    }

    @Test fun vip30dKey_equalsSecret() {
        assertEquals(AdKeys.VIP_SECRET, VipKeys.VIP_30D_KEY)
    }
